...
<nav class="navbar navbar-expand-md bg-info navbar-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="#" style="color: aqua">成果查看</a>
            </li>
            <li class="nav-item">
...
<div class="container" style="margin-top:80px">
    <form action="${pageContext.request.contextPath}/adminMain">
        <div class="row">
            ...
            <tr valign="top">
                <td align="center" colspan="12" rowspan="2">
                    <fkjava:pager
                            ...
                            submitUrl="${pageContext.request.contextPath}/adminMain?pageIndex={0}"/>
                </td>
            </tr>
            </tbody>
        </table>
