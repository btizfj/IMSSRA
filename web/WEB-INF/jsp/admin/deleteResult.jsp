        ...
        <table class="table table-bordered">
            ...
            <c:forEach items="${results}" var="result" varStatus="stat">
                <tr>
                    ...
                    <td>${result.time}</td>
                    <td><a href="${pageContext.request.contextPath}/modifyR111esult?result_id=${result.id}" target="_blank" class="text-primary">删除</a></td>
                </tr>
            </c:forEach>
            <!-- 分页标签 -->
            <tr valign="top">
                <td align="center" colspan="12" rowspan="2">
                    <fkjava:pager
                            ...
                            submitUrl="${pageContext.request.contextPath}/deleteResult"/>
                </td>
            </tr>
            </tbody>
        </table>
