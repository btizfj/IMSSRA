...
<head>
    ...
    <script language="JavaScript">
        ...
        $.ajax({
            type:"POST",
            url:getRootPath()+"/setGoodResultById",
            data:{"result_id":17},
...
<nav class="navbar navbar-expand-md bg-success navbar-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" style="color: aqua">优秀成果</a>
            </li>
            <li class="nav-item">
...
<div class="container" style="margin-top:80px">
    <form action="${pageContext.request.contextPath}/setGoodResult">
        <div class="row">
        ...
        <table class="table table-bordered">
            ...
            <c:forEach items="${results}" var="result" varStatus="stat">
                <tr>
                    ...
                    <td>${result.time}</td>
                    <td>${isGoodResule[result.isgood]}</td>
                    <c:choose>
                        <c:when test="${result.isgood == 0}">
                            <td><a href="${pageContext.request.contextPath}/setGoodResultById?result_id=${result.id}" class="text-primary" onclick="doSetGoodAjax()">确定</a></td>
                        </c:when>
                        <c:when test="${result.isgood == 1}">
                            <td><span style="color: green">已设</span></td>
                        </c:when>
                    </c:choose>
                </tr>
            </c:forEach>
            ...
            <tr valign="top">
                <td align="center" colspan="12" rowspan="2">
                    <fkjava:pager
                            ...
                            submitUrl="${pageContext.request.contextPath}/setGoodResult"/>
                </td>
            </tr>
            </tbody>
        </table>
