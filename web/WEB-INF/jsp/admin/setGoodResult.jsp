                ...
                <tr>
                    ...
                    <c:choose>
                        <c:when test="${result.isgood == 0}">
                            <td><a href="${pageContext.request.contextPath}/setGoodResultById?result_id=${result.id}" class="text-primary">确定</a></td>
                        </c:when>
            ...
            <tr valign="top">
                <td align="center" colspan="12" rowspan="2">
                    <fkjava:pager
                            ...
                            submitUrl="${pageContext.request.contextPath}/setGoodResult?pageIndex={0}"/>
                </td>
            </tr>
            </tbody>
        </table>
