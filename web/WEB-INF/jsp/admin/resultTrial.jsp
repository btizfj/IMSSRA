...
<div class="container" style="margin-top:80px">
    <form action="${pageContext.request.contextPath}/resultTrial">
        <div class="row">
            ...
            <c:forEach items="${results}" var="result" varStatus="stat">
                <tr>
                    ...
                    <c:choose>
                        ...
                        <c:when test="${result.trailstate == 2}">
                            <td><a class="text-primary" style="color: green">通过</a></td>
                        </c:when>
                    </c:choose>
            ...
            <tr valign="top">
                <td align="center" colspan="12" rowspan="2">
                    <fkjava:pager
                            ...
                            submitUrl="${pageContext.request.contextPath}/resultTrial?pageIndex={0}"/>
                </td>
            </tr>
            </tbody>
        </table>
