...
<nav class="navbar navbar-expand-md bg-success navbar-dark fixed-top">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#" onclick="openModel()" style="color: aqua">管理通知</a>
            </li>
            <li class="nav-item">
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${notifications}" var="notification" varStatus="stat">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/deleteNotificationById?id=${notification.id}" class="text-primary">删除</a></td>
                    </tr>
                </c:forEach>
                <!-- 分页标签 -->
                <tr valign="top">
