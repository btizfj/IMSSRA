package cn.yznu.imssra.controller.kindeditorcontroller;
...
/** 
 * @category HTML文件上传Controller 
 * @author yiz 
 * @date 2014-7-7上午9:35:18 
...
public class KindEditor4Module {  
    // 日志输出对象  
    private static Log log = LogFactory.getLog(KindEditor4Module.class);
    // 文件目录名称  
